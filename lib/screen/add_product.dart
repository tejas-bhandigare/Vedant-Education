...
//   void initState() {
//     super.initState();
//     originalPriceController.addListener(_calculatePrice);
//     discountController.addListener(_calculatePrice);
//   }
//
//   void _calculatePrice() {
//     double original = double.tryParse(originalPriceController.text) ?? 0;
...
//         const SnackBar(content: Text("Enter product title")),
//       );
//       return;
//     }
//
...
//       "price": finalPriceController.text.isEmpty
...
//         child: Column(
//           children: [
//             input("Product Title", titleController),
//
//             const SizedBox(height: 15),
//
//             input("Original Price", originalPriceController),
//
//             const SizedBox(height: 15),
//
//             input("Discount (%)", discountController),
//
//             const SizedBox(height: 15),
//
//             input("Final Price", finalPriceController, readOnly: true),
//
